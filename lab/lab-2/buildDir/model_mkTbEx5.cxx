...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h879;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h1255;
	 INST_top.DEF_i__h225 = INST_top.INST_mod_i.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_mod_mulStep = (INST_top.DEF_i__h225) < (tUInt8)8u;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h879 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h879;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomA_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1;
	 DEF_INST_top_DEF_tb_randomB_initialized__h1255 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h1255;
	 ...
	 INST_top.DEF_x__h2641 = INST_top.INST_tb_read_count.METH_read();
	 INST_top.DEF_tb_read_count_1_EQ_128___d52 = (INST_top.DEF_x__h2641) == 128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_read = INST_top.INST_tb_operands_fifo.METH_i_notEmpty() && (!(INST_top.DEF_tb_read_count_1_EQ_128___d52) && (INST_top.DEF_i__h225) == (tUInt8)8u);
	 ...
	 INST_top.DEF_x__h1662 = INST_top.INST_tb_feed_count.METH_read();
	 INST_top.DEF_x_wget__h1131 = INST_top.INST_tb_randomB_zaz.METH_wget();
	 INST_top.DEF_x_wget__h754 = INST_top.INST_tb_randomA_zaz.METH_wget();
	 INST_top.DEF_v__h1261 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h1131 : (tUInt8)0u;
	 INST_top.DEF_v__h885 = INST_top.INST_tb_randomA_zaz.METH_whas() ? INST_top.DEF_x_wget__h754 : (tUInt8)0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__2_THEN_tb_randomA_zaz__ETC___d32 = (INST_top.DEF_v__h885) == (tUInt8)128u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__9_THEN_tb_randomB_zaz__ETC___d33 = (INST_top.DEF_v__h1261) == (tUInt8)128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h879 && (DEF_INST_top_DEF_tb_randomB_initialized__h1255 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__2_THEN_tb_randomA_zaz__ETC___d32 || INST_top.DEF_IF_tb_randomB_zaz_whas__9_THEN_tb_randomB_zaz__ETC___d33) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h1662) == 128u) && (INST_top.DEF_i__h225) == (tUInt8)9u)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 || INST_top.DEF_CAN_FIRE_RL_mod_mulStep);
...
time_t MODEL_mkTbEx5::get_creation_time()
{
  ...
  /* Sun Sep 10 08:00:44 UTC 2023 */
  return 1694332844llu;
}
