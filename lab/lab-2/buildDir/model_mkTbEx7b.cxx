...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 INST_top.DEF_CAN_FIRE_RL_mod_mul_step = (INST_top.DEF__read__h138) < (tUInt8)31u;
	 ...
	 INST_top.DEF_CAN_FIRE_RL_tb_read = INST_top.INST_tb_operands_fifo.METH_i_notEmpty() && (!(INST_top.DEF_tb_read_count_6_EQ_128___d57) && (INST_top.DEF__read__h138) == (tUInt8)31u);
	 ...
	 INST_top.DEF_v__h973 = INST_top.DEF_tb_randomA_zaz_whas____d21 ? INST_top.DEF_IF_tb_randomA_zaz_whas__1_THEN_tb_randomA_zaz__ETC___d23 : 0u;
	 INST_top.DEF_v__h1349 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h1219 : 0u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__9_THEN_tb_randomB_zaz__ETC___d33 = (INST_top.DEF_v__h1349) == 1073741824u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__1_THEN_IF_tb_randomA_z_ETC___d32 = (INST_top.DEF_v__h973) == 1073741824u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h967 && (DEF_INST_top_DEF_tb_randomB_initialized__h1343 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__1_THEN_IF_tb_randomA_z_ETC___d32 || INST_top.DEF_IF_tb_randomB_zaz_whas__9_THEN_tb_randomB_zaz__ETC___d33) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h1722) == 128u) && (INST_top.DEF__read__h138) == (tUInt8)32u)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 || INST_top.DEF_CAN_FIRE_RL_mod_mul_step);
...
void MODEL_mkTbEx7b::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTbEx7b_instance->INST_tb_operands_fifo.set_clk_0)("CLK");
  (mkTbEx7b_instance->INST_tb_randomA_ignore.set_clk_0)("CLK");
  (mkTbEx7b_instance->INST_tb_randomA_zaz.set_clk_0)("CLK");
  (mkTbEx7b_instance->INST_tb_randomB_ignore.set_clk_0)("CLK");
  (mkTbEx7b_instance->INST_tb_randomB_zaz.set_clk_0)("CLK");
...
void MODEL_mkTbEx7b::get_version(char const **name, char const **build)
{
  *name = "2023.01";
  *build = "52adafa5";
}
...
time_t MODEL_mkTbEx7b::get_creation_time()
{
  ...
  /* Sun Sep 10 12:45:44 UTC 2023 */
  return 1694349944llu;
}
