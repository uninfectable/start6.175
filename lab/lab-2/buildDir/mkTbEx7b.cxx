 ...
 * 
 * On Sun Sep 10 12:45:44 UTC 2023
 * 
 */
...
MOD_mkTbEx7b::MOD_mkTbEx7b(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_mod_i(simHdl, "mod_i", this, 6u, (tUInt8)32u, (tUInt8)0u),
    INST_mod_m_neg(simHdl, "mod_m_neg", this, 63u),
    INST_mod_m_pos(simHdl, "mod_m_pos", this, 63u),
    INST_mod_p(simHdl, "mod_p", this, 63u),
    INST_tb_cycle(simHdl, "tb_cycle", this, 32u, 0u, (tUInt8)0u),
    INST_tb_feed_count(simHdl, "tb_feed_count", this, 32u, 0u, (tUInt8)0u),
    INST_tb_operands_fifo(simHdl, "tb_operands_fifo", this, 62u, 4u, (tUInt8)1u, 0u),
    INST_tb_randomA_ignore(simHdl, "tb_randomA_ignore", this, 31u, (tUInt8)0u),
    INST_tb_randomA_initialized(simHdl, "tb_randomA_initialized", this, 1u, (tUInt8)0u, (tUInt8)0u),
    INST_tb_randomA_zaz(simHdl, "tb_randomA_zaz", this, 31u, (tUInt8)0u),
    INST_tb_randomB_ignore(simHdl, "tb_randomB_ignore", this, 31u, (tUInt8)0u),
    INST_tb_randomB_initialized(simHdl, "tb_randomB_initialized", this, 1u, (tUInt8)0u, (tUInt8)0u),
    INST_tb_randomB_zaz(simHdl, "tb_randomB_zaz", this, 31u, (tUInt8)0u),
    INST_tb_read_count(simHdl, "tb_read_count", this, 32u, 0u, (tUInt8)0u),
    PORT_RST_N((tUInt8)1u),
    DEF_v__h1276(2863311530u),
    DEF_v__h899(2863311530u),
    DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68(124u)
{
  symbol_count = 45u;
...
{
  init_symbol(&symbols[0u], "_read__h138", SYM_DEF, &DEF__read__h138, 6u);
  ...
  init_symbol(&symbols[31u], "v__h1349", SYM_DEF, &DEF_v__h1349, 31u);
  init_symbol(&symbols[32u], "v__h973", SYM_DEF, &DEF_v__h973, 31u);
  ...
  init_symbol(&symbols[43u], "x_wget__h1219", SYM_DEF, &DEF_x_wget__h1219, 31u);
  init_symbol(&symbols[44u], "x_wget__h842", SYM_DEF, &DEF_x_wget__h842, 31u);
}


/* Rule actions */

void MOD_mkTbEx7b::RL_mod_mul_step()
{
  tUInt64 DEF_a__h345;
  tUInt64 DEF_a__h259;
  tUInt64 DEF_x__h240;
  tUInt64 DEF_IF_mod_p_BITS_1_TO_0_EQ_0b1_THEN_mod_p_PLUS_mo_ETC___d15;
  tUInt64 DEF_x__h376;
  tUInt64 DEF_x__h326;
  tUInt8 DEF_pr__h156;
  tUInt64 DEF_y__h352;
  ...
  DEF_x__h376 = primShiftRA64(63u, 63u, (tUInt64)(DEF_mod_p__h1825), 32u, 1u);
  DEF_a__h259 = 9223372036854775807llu & (DEF_mod_p__h1825 + DEF_y__h281);
  DEF_x__h240 = primShiftRA64(63u, 63u, (tUInt64)(DEF_a__h259), 32u, 1u);
  DEF_a__h345 = 9223372036854775807llu & (DEF_mod_p__h1825 + DEF_y__h352);
  DEF_x__h326 = primShiftRA64(63u, 63u, (tUInt64)(DEF_a__h345), 32u, 1u);
  switch (DEF_pr__h156) {
  case (tUInt8)1u:
  ...
  DEF_x__h426 = (tUInt8)63u & (DEF__read__h138 + (tUInt8)1u);
...
{
  tUInt32 DEF_new_value__h941;
  if (!(PORT_RST_N == (tUInt8)0u))
    DEF_v__h899 = rand32();
  DEF_new_value__h941 = (tUInt32)(2147483647u & DEF_v__h899);
...
void MOD_mkTbEx7b::RL_tb_randomA_every_1()
{
  ...
  DEF_v__h973 = DEF_tb_randomA_zaz_whas____d21 ? DEF_IF_tb_randomA_zaz_whas__1_THEN_tb_randomA_zaz__ETC___d23 : 0u;
  INST_tb_randomA_ignore.METH_wset(DEF_v__h973);
}

void MOD_mkTbEx7b::RL_tb_randomB_every()
{
  tUInt32 DEF_new_value__h1318;
  if (!(PORT_RST_N == (tUInt8)0u))
    DEF_v__h1276 = rand32();
  DEF_new_value__h1318 = (tUInt32)(2147483647u & DEF_v__h1276);
...
void MOD_mkTbEx7b::RL_tb_randomB_every_1()
{
  ...
  DEF_v__h1349 = INST_tb_randomB_zaz.METH_whas() ? DEF_x_wget__h1219 : 0u;
  INST_tb_randomB_ignore.METH_wset(DEF_v__h1349);
}

void MOD_mkTbEx7b::RL_tb_feed()
{
  tUInt64 DEF_IF_tb_randomA_zaz_whas__1_THEN_IF_tb_randomA_z_ETC___d48;
  tUInt64 DEF_x__h1622;
  tUInt64 DEF_x__h1656;
  tUInt64 DEF_x__h1589;
  ...
  DEF_v__h973 = DEF_tb_randomA_zaz_whas____d21 ? DEF_IF_tb_randomA_zaz_whas__1_THEN_tb_randomA_zaz__ETC___d23 : 0u;
  DEF_v__h1349 = INST_tb_randomB_zaz.METH_whas() ? DEF_x_wget__h1219 : 0u;
  DEF_IF_tb_randomB_zaz_whas__9_THEN_tb_randomB_zaz__ETC___d33 = DEF_v__h1349 == 1073741824u;
  DEF_IF_tb_randomA_zaz_whas__1_THEN_IF_tb_randomA_z_ETC___d32 = DEF_v__h973 == 1073741824u;
  ...
  DEF_x__h1589 = 9223372036854775807llu & (((((tUInt64)(0u)) << 32u) | (((tUInt64)(DEF_v__h1349)) << 1u)) | (tUInt64)((tUInt8)0u));
  DEF_x__h1622 = 9223372036854775807llu & ((((tUInt64)(DEF_v__h973)) << 32u) | (tUInt64)(0u));
  DEF_x__h1656 = 9223372036854775807llu & ((((tUInt64)(DEF_tb_randomA_zaz_whas____d21 ? 2147483647u & -DEF_IF_tb_randomA_zaz_whas__1_THEN_tb_randomA_zaz__ETC___d23 : 0u)) << 32u) | (tUInt64)(0u));
  DEF_IF_tb_randomA_zaz_whas__1_THEN_IF_tb_randomA_z_ETC___d48 = 4611686018427387903llu & ((((tUInt64)(DEF_v__h973)) << 31u) | (tUInt64)(DEF_v__h1349));
...
{
  tUInt8 DEF_NOT_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_f_ETC___d74;
  tUInt32 DEF_signed_tb_operands_fifo_first__3_BITS_30_TO_0_6___d72;
  tUInt32 DEF_signed_tb_operands_fifo_first__3_BITS_61_TO_31_4___d71;
  tUInt64 DEF_signed_mod_p_BITS_62_TO_1_2___d73;
  tUInt64 DEF_signed_SEXT_tb_operands_fifo_first__3_BITS_61_ETC___d75;
  tUInt8 DEF_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_fifo__ETC___d70;
  tUInt32 DEF_x__h2155;
  tUInt64 DEF_tb_operands_fifo_first____d63;
  tUInt32 DEF_b__h1743;
  tUInt32 DEF_a__h1742;
  tUInt64 DEF_v__h1767;
  tUInt64 DEF_expected__h1830;
  DEF_x__h2279 = INST_tb_read_count.METH_read();
  DEF_mod_p__h1825 = INST_mod_p.METH_read();
  DEF_v__h1767 = (tUInt64)(DEF_mod_p__h1825 >> 1u);
  DEF_tb_operands_fifo_first____d63 = INST_tb_operands_fifo.METH_first();
  DEF_a__h1742 = (tUInt32)(DEF_tb_operands_fifo_first____d63 >> 31u);
  DEF_b__h1743 = (tUInt32)(2147483647u & DEF_tb_operands_fifo_first____d63);
  DEF__read__h138 = INST_mod_i.METH_read();
  DEF_x__h2155 = DEF_x__h2279 + 1u;
  DEF_x__h426 = (tUInt8)63u & (DEF__read__h138 + (tUInt8)1u);
  DEF_signed_mod_p_BITS_62_TO_1_2___d73 = DEF_v__h1767;
  DEF_signed_tb_operands_fifo_first__3_BITS_61_TO_31_4___d71 = DEF_a__h1742;
  DEF_signed_tb_operands_fifo_first__3_BITS_30_TO_0_6___d72 = DEF_b__h1743;
  wop_mul(WideData(62u, primSignExt64(62u, 31u, (tUInt32)(DEF_a__h1742))),
	  WideData(62u, primSignExt64(62u, 31u, (tUInt32)(DEF_b__h1743))),
	  DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68);
  DEF_expected__h1830 = primExtract64(62u,
				      124u,
				      DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68,
				      32u,
				      61u,
				      32u,
				      0u);
  DEF_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_fifo__ETC___d70 = DEF_v__h1767 == DEF_expected__h1830;
  DEF_signed_SEXT_tb_operands_fifo_first__3_BITS_61_ETC___d75 = DEF_expected__h1830;
  DEF_NOT_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_f_ETC___d74 = !DEF_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_fifo__ETC___d70;
  INST_tb_operands_fifo.METH_deq();
  INST_mod_i.METH_write(DEF_x__h426);
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    if (DEF_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_fifo__ETC___d70)
    ...
    if (DEF_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_fifo__ETC___d70)
      dollar_display(sim_hdl,
		     ...
		     "s,-31,-31,-62",
		     &__str_literal_2,
		     DEF_signed_tb_operands_fifo_first__3_BITS_61_TO_31_4___d71,
		     DEF_signed_tb_operands_fifo_first__3_BITS_30_TO_0_6___d72,
		     DEF_signed_mod_p_BITS_62_TO_1_2___d73);
    if (DEF_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_fifo__ETC___d70)
      dollar_display(sim_hdl,
		     this,
		     "s,31,31,62",
		     ...
		     DEF_b__h1743,
		     DEF_v__h1767);
    if (DEF_NOT_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_f_ETC___d74)
    ...
    if (DEF_NOT_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_f_ETC___d74)
      dollar_display(sim_hdl,
		     ...
		     DEF_signed_tb_operands_fifo_first__3_BITS_30_TO_0_6___d72,
		     DEF_signed_mod_p_BITS_62_TO_1_2___d73,
		     DEF_signed_SEXT_tb_operands_fifo_first__3_BITS_61_ETC___d75);
    if (DEF_NOT_mod_p_BITS_62_TO_1_2_EQ_SEXT_tb_operands_f_ETC___d74)
      dollar_display(sim_hdl,
		     this,
		     "s,31,31,62,62",
...
unsigned int MOD_mkTbEx7b::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "IF_tb_randomA_zaz_whas__1_THEN_tb_randomA_zaz__ETC___d23", 31u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "IF_tb_randomB_zaz_whas__9_THEN_tb_randomB_zaz__ETC___d33", 1u);
  vcd_write_def(sim_hdl, num++, "RST_N", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68", 124u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "_read__h138", 6u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "mod_p__h1825", 63u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "v__h1349", 31u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "v__h899", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "v__h973", 31u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h1722", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2279", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h426", 6u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x_wget__h1219", 31u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x_wget__h842", 31u);
...
void MOD_mkTbEx7b::vcd_defs(tVCDDumpType dt, MOD_mkTbEx7b &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_IF_tb_randomA_zaz_whas__1_THEN_IF_tb_randomA_z_ETC___d32 = DEF_IF_tb_randomA_zaz_whas__1_THEN_IF_tb_randomA_z_ETC___d32;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_IF_tb_randomA_zaz_whas__1_THEN_tb_randomA_zaz__ETC___d23, 31u);
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68) != DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68)
      {
	vcd_write_val(sim_hdl, num, DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68, 124u);
	backing.DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68 = DEF_SEXT_tb_operands_fifo_first__3_BITS_61_TO_31_4_ETC___d68;
      }
      ++num;
	...
	backing.DEF_WILL_FIRE_RL_tb_read = DEF_WILL_FIRE_RL_tb_read;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF__read__h138, 6u);
	backing.DEF__read__h138 = DEF__read__h138;
      }
      ++num;
      if ((backing.DEF_mod_p__h1825) != DEF_mod_p__h1825)
      {
	vcd_write_val(sim_hdl, num, DEF_mod_p__h1825, 63u);
	...
	backing.DEF_v__h1276 = DEF_v__h1276;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_v__h1349, 31u);
	...
	backing.DEF_v__h899 = DEF_v__h899;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_v__h973, 31u);
