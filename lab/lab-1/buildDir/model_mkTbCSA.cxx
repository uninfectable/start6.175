...
/* Constructor */
MODEL_mkTbCSA::MODEL_mkTbCSA()
{
  mkTbCSA_instance = NULL;
}

/* Function for creating a new model */
void * new_MODEL_mkTbCSA()
{
  MODEL_mkTbCSA *model = new MODEL_mkTbCSA();
  return (void *)(model);
}
...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
       {
	 MOD_mkTbCSA &INST_top = *((MOD_mkTbCSA *)(instance_ptr));
...
void MODEL_mkTbCSA::create_model(tSimStateHdl simHdl, bool master)
{
  sim_hdl = simHdl;
  init_reset_request_counters(sim_hdl);
  mkTbCSA_instance = new MOD_mkTbCSA(sim_hdl, "top", NULL);
  ...
  (mkTbCSA_instance->INST_randomVal1_ignore.set_clk_0)("CLK");
  (mkTbCSA_instance->INST_randomVal1_zaz.set_clk_0)("CLK");
  (mkTbCSA_instance->INST_randomVal2_ignore.set_clk_0)("CLK");
  (mkTbCSA_instance->INST_randomVal2_zaz.set_clk_0)("CLK");
  (mkTbCSA_instance->set_clk_0)("CLK");
}
void MODEL_mkTbCSA::destroy_model()
{
  delete mkTbCSA_instance;
  mkTbCSA_instance = NULL;
}
void MODEL_mkTbCSA::reset_model(bool asserted)
{
  (mkTbCSA_instance->reset_RST_N)(asserted ? (tUInt8)0u : (tUInt8)1u);
}
void * MODEL_mkTbCSA::get_instance()
{
  return mkTbCSA_instance;
}

/* Fill in version numbers */
void MODEL_mkTbCSA::get_version(char const **name, char const **build)
{
  *name = "2023.01";
  *build = "52adafa5";
}
...
time_t MODEL_mkTbCSA::get_creation_time()
{
  
  /* Wed Sep  6 08:43:37 UTC 2023 */
  return 1693989817llu;
}

/* State dumping function */
void MODEL_mkTbCSA::dump_state()
{
  (mkTbCSA_instance->dump_state)(0u);
}

/* VCD dumping functions */
MOD_mkTbCSA & mkTbCSA_backing(tSimStateHdl simHdl)
{
  static MOD_mkTbCSA *instance = NULL;
  if (instance == NULL)
  {
    vcd_set_backing_instance(simHdl, true);
    instance = new MOD_mkTbCSA(simHdl, "top", NULL);
    vcd_set_backing_instance(simHdl, false);
  }
  return *instance;
}
void MODEL_mkTbCSA::dump_VCD_defs()
{
  (mkTbCSA_instance->dump_VCD_defs)(vcd_depth(sim_hdl));
}
void MODEL_mkTbCSA::dump_VCD(tVCDDumpType dt)
{
  (mkTbCSA_instance->dump_VCD)(dt, vcd_depth(sim_hdl), mkTbCSA_backing(sim_hdl));
}
