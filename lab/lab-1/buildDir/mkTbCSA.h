...
/* Generation options: */
#ifndef __mkTbCSA_h__
#define __mkTbCSA_h__
...
/* Class declaration for the mkTbCSA module */
class MOD_mkTbCSA : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkTbCSA(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkTbCSA &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkTbCSA &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkTbCSA &backing);
};

#endif /* ifndef __mkTbCSA_h__ */
