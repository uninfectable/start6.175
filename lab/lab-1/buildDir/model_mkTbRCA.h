...
/* Generation options: */
#ifndef __model_mkTbRCA_h__
#define __model_mkTbRCA_h__
...
/* Class declaration for a model of mkTbRCA */
class MODEL_mkTbRCA : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkTbRCA *mkTbRCA_instance;
...
#endif /* ifndef __model_mkTbRCA_h__ */
